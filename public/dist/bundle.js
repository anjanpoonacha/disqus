...
exports.dislikeComment = exports.likeComment = exports.addComment = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(document, text, commentType, Comment) {
    var res, model, slug, comment, htmlDirectComment, htmlSubComment, html;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            model = commentType;
            slug = document.location.pathname.split('/')[1];
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
          ...
          case 5:
            res = _context.sent;
            comment = _objectSpread({}, res.data.comment); // HTML ELEMENT FOR  DIRECT COMMENT

            htmlDirectComment = "\n    <div class=\"comment__wrapper comment__wrapper-direct-".concat(comment.Post, "\"><img class=\"comment__user-img\" src=\"/img/").concat(comment.postedBy, ".png\"\n    alt=\"User\">\n  <div class=\"comment__user-name\">").concat(comment.postedBy, "</div>\n  <div class=\"comment__text\">").concat(comment.text, "</div>\n</div>\n<div class=\"comment__cta mg-bt-sm comment__cta--direct-").concat(comment.Post, "\">\n  <div class=\"btn-reply\" id=\"reply-checkbox--0\" role=\"checkbox\" onclick=\"changeCheckbox()\" aria-checked=\"false\">Reply\n  </div>\n  <div class=\"btn-like\" aria-pressed=\"false\" role=\"button\">Like ").concat(comment.likes, "</div>\n  <div class=\"btn-dislike\" aria-pressed=\"false\" role=\"button\">Dislike ").concat(comment.dislikes, "</div>\n  <form class=\"form--comment-sub\"><textarea class=\"form__text form__text-").concat(comment.Post, "\"\n      placeholder=\"Write your thoughts...\" required=\"\" name=\"comment\" id=\"\" rows=\"5\"\n      style=\"resize: none; width: 100%; \"></textarea><button\n      class=\"btn btn--grey btn--reply btn-comment.Post\" type=\"submit\">Add comment</button></form>\n</div>\n    "); // HTML ELEMENT FOR SUBCOMMENT

            htmlSubComment = "\n    <div class=\"sub-comment\">\n  <div class=\"comment__wrapper comment__wrapper-sub-".concat(comment._id, "\">\n    <img class=\"comment__user-img\" src=\"/img/default.png\" alt=\"User 1\" />\n    <div class=\"comment__user-name\">").concat(comment.postedBy, "</div>\n    <div class=\"comment__text\"><p>").concat(comment.text, "</p></div>\n  </div>\n  <div class=\"comment__cta mg-bt-sm comment__cta--sub-").concat(comment._id, "\">\n    <div\n      class=\"btn-like\"\n      aria-pressed=\"false\"\n      role=\"button\"\n      id=\"like-").concat(comment._id, "\"\n    >\n      Like 0\n    </div>\n    <div\n      class=\"btn-dislike\"\n      aria-pressed=\"false\"\n      role=\"button\"\n      id=\"like-").concat(comment._id, "\"\n    >\n      Dislike 0\n    </div>\n  </div>\n</div>");

            // RENDER HTML
            if (commentType === 'comment') {
              html = htmlDirectComment;
              document.querySelector('.form--comment-direct').insertAdjacentHTML('afterend', html); //
            } else if (commentType === 'subcomment') {
              //
              html = htmlSubComment;
              document.querySelector(".comment__cta--direct-".concat(Comment)).insertAdjacentHTML('afterend', html);
            } // CLOSE REPLY FORM


            document.querySelectorAll('.btn-reply').forEach(function (el) {
              el.setAttribute('aria-checked', false);
            }); // SHOW ALERT

            if (res.data.status === 'SUCCESS') {
              (0, _alert.showAlert)('success', 'Comment successful');
            }
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(commentType, commentId) {
    var res;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(commentType, commentId) {
    var res;
...
var commentFormDirect = document.querySelector('.form--comment-direct');
...
if (commentFormDirect) {
  var textArea = document.querySelector('.form__text');
  commentFormDirect.addEventListener('submit', function (e) {
    e.preventDefault();
    var formText = textArea.value;
    textArea.value = '';
    (0, _comment.addComment)(document, formText, 'comment');
  });
}
...
document.addEventListener('submit', function (e) {
  ...
  if (e.srcElement != commentFormDirect) {
    var commentId = e.target.id.split('--')[1];

    try {
      text = document.querySelector(".form__text-".concat(commentId)).value;
    } catch (err) {
      (0, _alert.showAlert)('error', 'Please reload the page before commenting');
    }

    (0, _comment.addComment)(document, text, 'subcomment', commentId);
  }
});
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            apAttr = 'aria-pressed';
            commentId = e.srcElement.id;
            likeBtn = document.getElementById("".concat(commentId.split('-')[0], "-like-").concat(commentId.split('-')[2]));
            dislikeBtn = document.getElementById("".concat(commentId.split('-')[0], "-dislike-").concat(commentId.split('-')[2])); // console.log(JSON.parse(likeBtn.getAttribute(apAttr)));
